  ...
  if (isActive) {
    return (
      <button
        ...
        className="px-2.5 py-1 text-xs font-medium rounded-lg bg-red-100 text-red-700 hover:bg-red-200 disabled:opacity-50 transition-colors border border-red-200"
      >
  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className="px-2.5 py-1 text-xs font-medium rounded-lg bg-emerald-600 text-white hover:bg-emerald-700 disabled:opacity-50 transition-colors"
      >
