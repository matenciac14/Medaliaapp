...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Coach: revisar y aprobar plan generado por AI', done: true, note: 'UI de revisión por semana' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Directorio público de coaches (/coaches)', done: false, note: 'Grid con filtros por deporte + AI Coach card destacada' },
      { title: 'Perfil público del coach (/p/[slug])', done: false, note: 'Bio, programas, posts, CTA unirse' },
      { title: 'Perfil AI Coach (/p/ai-coach)', done: false, note: 'Coach inteligente como opción del marketplace' },
      { title: 'Coach edita su perfil público', done: false, note: 'Slug, bio, especialidades, programas, publicaciones' },
      { title: 'Coach publica contenido (tips, rutinas, logros)', done: false, note: 'Feed visible en perfil público' },
      { title: 'Coach crea asesorado directamente', done: false, note: 'Sin código invitación — genera credenciales temporales' },
      { title: 'Atleta se une a coach desde marketplace', done: false, note: 'POST /api/coach/join desde /p/[slug]' },
  ...
  },
  {
    ...
    borderColor: '#d8b4fe',
    items: [
      { title: 'Variables de entorno en producción', done: false, note: 'NEXTAUTH_SECRET, DATABASE_URL, ANTHROPIC_API_KEY, NEXTAUTH_URL' },
      { title: 'PostgreSQL en Neon (serverless)', done: false, note: 'Crear proyecto en neon.tech, copiar connection string' },
