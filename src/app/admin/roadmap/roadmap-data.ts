    ...
    phases: [
      {
        ...
        items: [
          ...
          { title: 'Open Graph tags (og:title, og:description, og:image) para preview en WhatsApp/LinkedIn/Twitter', done: true, priority: 'P0', note: 'opengraph-image.tsx genera imagen dinámica en /opengraph-image. generateMetadata en /coaches + /p/[slug]. META_IMAGE actualizado.  ORIG: layout.tsx: openGraph + twitter card + alternates/hreflang configurados. og:image apunta a /og-image.png pero el archivo NO existe en /public/ — el preview en WhatsApp/LinkedIn mostrará imagen en blanco. Pendiente: crear /public/og-image.png (1200×630px).' },
      ...
      },
      {
        ...
        items: [
          { title: 'Schema JSON-LD: Organization + SoftwareApplication — rich results en Google', done: true, priority: 'P1', note: 'JsonLd component en src/components/seo/json-ld.tsx. WebSite schema en layout.tsx. Person schema en /p/[slug]. Orig: Permite que Google muestre rating, precio y descripción del producto directamente en resultados de búsqueda.' },
          ...
          { title: 'WhatsApp flotante o widget de contacto directo (estándar en LatAm)', done: true, priority: 'P1', note: 'WhatsAppButton client component. Visible en /,/coaches,/login,/register,/p/*. Oculto en rutas privadas via usePathname(). Orig: En LatAm los coaches resuelven dudas por WhatsApp antes de registrarse. Sin canal de contacto directo se pierde el 30-40% de prospectos calientes.' },
