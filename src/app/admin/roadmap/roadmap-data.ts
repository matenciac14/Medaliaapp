    ...
    phases: [
      ...
      // ── PERFORMANCE & FAT ROUTES — Auditoría 2026-07-03 ─────────────────────
      {
        ...
        items: [
          ...
          { title: 'PERF-05 — Dashboard web 873 LOC: lógica de getDashboardSummary duplicada inline — mobile ya usa el use case del dominio', done: false, priority: 'P1', note: 'PENDIENTE: Scope amplio — el page.tsx tiene lógica extra (coachRelation, weekActivities, lifecycle writes, adherencia) que el use case no cubre. Requiere sesión dedicada para el refactor sin riesgo de regresiones.' },
