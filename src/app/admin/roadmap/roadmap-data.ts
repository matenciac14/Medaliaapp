    ...
    phases: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            priority: 'P0',
            note: 'Pendiente: (1) configurar WORKOUTX_API_KEY en Vercel env vars, (2) llamar POST /api/admin/exercises/sync desde el panel admin. El código está listo. Sin este seed la biblioteca de ejercicios tiene solo los 39 ejercicios custom del seed manual.',
          },
        ],
      },
      {
