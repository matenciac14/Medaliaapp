...
export const GROUPS: RoadmapGroup[] = [
...

  {
    ...
    items: [
      ...
      { title: 'Admin P0: dashboard financiero — MRR estimado, fee por coach, cobros pendientes', done: false, priority: 'P0', note: 'El fundador no tiene visibilidad de ingresos. Calcular: coachOf.length × $6 por coach + suscripciones Pro. Payment records ya existen en DB. Pantalla /admin/finanzas.' },
      { title: 'Admin P0: funnel de activación — registro → onboarding → plan activo → check-in esta semana', done: false, priority: 'P0', note: 'Sin esto el fundador no sabe dónde se caen los usuarios. 4 contadores con % de conversión entre cada paso.' },
      { title: 'Admin P1: feed de alertas operativas — atletas en /pending > 48h, coaches sin atletas > 7d', done: false, priority: 'P1', note: 'Señales de negocio que requieren intervención manual. Widget en /admin o sección dedicada.' },
      { title: 'Admin P1: log de actividad — audit trail de acciones admin (quién, qué, cuándo)', done: false, priority: 'P1', note: 'Tabla AdminAuditLog { adminId, action, targetUserId, meta, createdAt }. Sin esto no se puede rastrear qué causó un estado incorrecto.' },
