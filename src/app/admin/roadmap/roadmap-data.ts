    ...
    phases: [
      ...
      // ── NUTRICIÓN & PROGRESO ──────────────────────────────────────────────────
      {
        ...
        items: [
          ...
          { title: 'BUG-035 — /api/mobile/nutrition/log/summary: adherencePct siempre vs targetKcalEasy, ignora tipo de día', done: false, priority: 'P2', note: 'summary/route.ts:47 — targetKcal = nutritionPlan?.targetKcalEasy ?? 0. Fix pendiente: calcular target real por día según FoodLog.date + PlannedSession.intensity.' },
          { title: 'BUG-036 — NutritionPlan lazy-init en web pero no en mobile: estado diverge entre canales', done: false, priority: 'P3', note: 'nutrition/page.tsx crea NutritionPlan si no existe. api/mobile/nutrition/route.ts devuelve null sin crearlo. Fix pendiente: helper compartido de lazy-init.' },
