    ...
    phases: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'NUT-WATER-01 — WaterLog tracking web: endpoint POST + widget con botones +250ml/+500ml/+1L', done: true, priority: 'P2', note: 'DONE 2026-07-29. GET /api/nutrition/water → { mlLogged, waterMlTarget } (parallel: WaterLog + NutritionPlan.waterMlTarget). POST /api/nutrition/water body { delta } → upsert Math.max(0, existing + delta). HydrationWidget.tsx: client component, fetch al montar, update optimista, barra azul h-2, 3 botones (+250ml/+500ml/+1L), badge "¡Meta lograda!" a 100%. Visible cuando effectiveNutritionPlan en /nutrition. Archivos: src/app/api/nutrition/water/route.ts + _components/HydrationWidget.tsx + nutrition/page.tsx.' },
