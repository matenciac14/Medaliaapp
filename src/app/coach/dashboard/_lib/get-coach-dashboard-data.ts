...
import { getCoachDashboardSummary, type DashboardInput } from '@/domain/coach-dashboard/get-coach-dashboard.use-case'
import type { CoachDashboardSummary } from '@/domain/coach-dashboard/coach-dashboard.types'
