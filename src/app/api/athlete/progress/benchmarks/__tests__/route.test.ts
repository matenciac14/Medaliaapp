...
function makeReq(method: string, body?: unknown): NextRequest {
  return new NextRequest(`http://localhost/api/athlete/progress/benchmarks`, {
    method,
...
describe('GET /api/athlete/progress/benchmarks', () => {
...
describe('POST /api/athlete/progress/benchmarks', () => {
  it('retorna 401 sin sesión', async () => {
    vi.mocked(auth).mockResolvedValue(null as any)
...
describe('DELETE /api/athlete/progress/benchmarks', () => {
