...
vi.mock('@/domain/nutrition/calculate-nutrition-adjustment', () => ({
...
function postReq(body: object) {
  return new NextRequest(new URL('/api/log/session', 'http://localhost'), {
    method: 'POST',
...
describe('POST /api/log/session — PERSIST-06', () => {
