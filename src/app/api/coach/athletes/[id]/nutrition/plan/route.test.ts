...
function makeGetReq(qs = '') {
  return new NextRequest(new URL(`/api/coach/athletes/${ATHLETE_ID}/nutrition/plan${qs}`, 'http://localhost'))
}

function makePostReq(body: unknown) {
  return new NextRequest(new URL(`/api/coach/athletes/${ATHLETE_ID}/nutrition/plan`, 'http://localhost'), {
    method: 'POST',
...
describe('GET /api/coach/athletes/[id]/nutrition/plan', () => {
...
describe('POST /api/coach/athletes/[id]/nutrition/plan', () => {
  it('retorna 401 sin sesión', async () => {
    vi.mocked(auth).mockResolvedValue(null as any)
