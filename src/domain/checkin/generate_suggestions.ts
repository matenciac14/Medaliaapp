...
export function generateSuggestions(
  ...
  // PLAN_ADJUSTMENT — triggers de sesión restantes (subjectivos + objetivos)
  const sessionTriggers = [...remainingTriggers].filter(t =>
    ['dolor_activo', 'rpe_excesivo', 'estres_alto', 'sueno_bajo', 'energia_baja', 'fc_alta',
     'sin_descanso', 'pico_volumen', 'sesion_muy_intensa', 'rpe_discrepancia'].includes(t)
  )
