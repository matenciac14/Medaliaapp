...
import { buildStaticMealPlan, computeNutritionTargets, parseMealPlanData, type MacroTargets } from './generate_meal_plan'
...
const DB_PROTEIN: import('./generate_meal_plan').DbFood = {
...
const DB_CARB: import('./generate_meal_plan').DbFood = {
...
const DB_VEG: import('./generate_meal_plan').DbFood = {
  name: 'Brócoli',
  category: 'VEGETABLE',
  kcalPer100g: 34,
  proteinPer100g: 2.8,
...
const DB_FRUIT: import('./generate_meal_plan').DbFood = {
...
const DB_FAT: import('./generate_meal_plan').DbFood = {
  name: 'Aguacate',
  category: 'FAT',
  kcalPer100g: 160,
  proteinPer100g: 2,
...
describe('buildStaticMealPlan — dbFoods: rotación entre múltiples alimentos', () => {
  const DB_PROTEIN_2: import('./generate_meal_plan').DbFood = {
    name: 'Huevo entero',
    category: 'PROTEIN',
    kcalPer100g: 155,
    proteinPer100g: 13,
...
function mockFood(overrides: Partial<import('./generate_meal_plan').DbFood> = {}): import('./generate_meal_plan').DbFood {
  return {
    name: 'Pollo',
    category: 'PROTEIN',
    kcalPer100g: 120,
...
const INPUT_B: import('./generate_meal_plan').GenerateMealsInput = {
