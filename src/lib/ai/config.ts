...
export type AIConfig = {
  ...
  monthlyLimitInactive: number  // mensajes/mes para usuarios Inactive (default 0)
...
export function getAIConfig(): AIConfig {
  return {
    ...
    monthlyLimitInactive: Number(process.env.AI_MONTHLY_LIMIT_INACTIVE ?? DEFAULT_AI_CONFIG.monthlyLimitInactive),
